            ...
            <div class="card-body">
                <div class="ps-0">
                    <div class="main-profile-overview">
                        ...
                        Do-while adalah salah satu pernyataan pengulangan yang memungkinkan kita untuk membuat program yang berjalan secara fleksibel berdsarkan keinginan pengguna.
                         Do-while berfungsi untuk mengulangi pengeksekusian beberapa pernyataan berdsarkan conditional expression yang ada.
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div>
                            <h6 class="card-title mb-1">do-while</h6>
