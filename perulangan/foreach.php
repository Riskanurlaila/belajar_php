            ...
            <div class="card-body">
                <div class="ps-0">
                    <div class="main-profile-overview">
                        ...
                        perulangan foreach pada PHP yaitu merupakan perulangan khusus untuk pembacaan nilai array dimana array memiliki pasangan key dan value, key adalah posisi array sedangkan value adalah isi dari array
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div>
                            <h6 class="card-title mb-1">Foreach</h6>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Foreach Loop Display</title>
    <body>
    <body>
        <div id="container">
        <div id="overlay">
